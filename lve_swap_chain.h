...
class LveSwapChain {
 public:
  ...
  LveSwapChain(LveDevice& deviceRef, VkExtent2D windowExtent, std::shared_ptr<LveSwapChain> previous); // for providing old Swapchain for compability check and performance saving
  ~LveSwapChain();
